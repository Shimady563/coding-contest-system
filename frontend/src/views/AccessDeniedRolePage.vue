<template>
  <div class="access-denied-container">
    <div class="access-denied-card">
      ...
      <p class="details">
        Эта страница доступна только преподавателям. Если вы считаете, что это ошибка, обратитесь к
        администратору системы.
      </p>
      <div class="actions">
        <router-link to="/" class="btn primary-btn">На главную</router-link>
        <button v-if="isStudent" @click="logout" class="btn secondary-btn">
          Выйти и войти как преподаватель
        </button>
      </div>
    </div>
  </div>
