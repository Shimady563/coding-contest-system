...
const routes = [
  ...
  {
    path: '/contests/:contestId/contest-version/:versionId/task/:taskId',
    component: ContestSolving,
    name: 'ContestSolving',
  },

  {
    path: '/manage-contests',
    component: ManageTasksContests,
    meta: { requiresAuth: true, requiresTeacher: true },
  },
  {
    path: '/manage-contests/create-contest',
    component: ContestForm,
    meta: { requiresAuth: true, requiresTeacher: true },
  },
  {
    path: '/manage-contests/create-task',
    component: TaskForm,
    meta: { requiresAuth: true, requiresTeacher: true },
  },
  {
    path: '/manage-contests/edit-contest/:id',
    component: ContestForm,
    props: true,
    meta: { requiresAuth: true, requiresTeacher: true },
  },
  {
    path: '/manage-contests/edit-task/:id',
    component: TaskForm,
    props: true,
    meta: { requiresAuth: true, requiresTeacher: true },
  },
